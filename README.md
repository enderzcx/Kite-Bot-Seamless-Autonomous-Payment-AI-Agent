...
| **🗓 Open Day (开幕式)** | **1月28日 19:00-20:30** | 📍 Zoom | [Zoom 链接] |
...
- **Non-Coder 友好建议**：鼓励类似“产品经理 + 开发工程师 + UI 设计师”的跨界组合；即使不会代码，也可以负责产品设计与逻辑规划，利用 AI 工具将想法落地。
### **🎁 奖项和奖励**

本次休闲黑客松总奖金池高达 **$2,500 USDT**，覆盖 3 个参赛赛道，奖金具体金额将根据最终报名与参赛项目进行调整。所有参赛者团队都有机会**瓜分总奖金池**，并可获得由 LXDAO 颁发的**专属创意 Badge NFT**。
