...
| --------- | --------- | -------- | -------- | -------- | ---- | -------- |
| 测试 | [@beetroot42](https://github.com/beetroot42) | 测试<br>_格式: Telegram: @username，微信: username，邮箱: email@example.com_ | 测试 | 测试<br>_例如：支付赛道 / LLM 应用赛道 / 预测市场赛道_ | 测试 | [Link](https://github.com/CasualHackathon/SPARK-AI-Hackathon/issues/36) |
